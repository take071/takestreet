...
| **Modular Routing** | Gerenciamento centralizado de rotas no `app.py`, facilitando manutenção e debug |
| **Environment Reproducibility** | Controle rigoroso de dependências via `requirements.txt`, garantindo consistência entre ambientes |
